...
assert.equal(administrator.facilityId,null);
assert.equal(assignStaff(adminGame,administrator.id,adminEd.id),false);
...
assert.equal(surgeryGame.phase,'operations');
