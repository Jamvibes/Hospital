...
export function createGame(seed=1){
  const state={round:1,phase:'assignment',money:10,reputation:5,deck:shuffle(clone(PATIENTS),seed),discard:[],facilities:[],staff:[],resources:{medication:0,surgery:0},log:[],gameOver:false,nextId:1};
