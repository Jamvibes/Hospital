...
function theatreSpaces(f,capacity){return Array.from({length:capacity},(_,i)=>{const patient=f.patients[i];if(patient)return `<div class="theatre-space …429 tokens truncated…needs">${risk.unmet} unmet Â· ${risk.label}</span>`:'';
