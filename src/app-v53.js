import {createGame,investigate,treat,admit,buy,advancePhase,assignStaff,returnStaff,placeFacility,compatible,getFacility,previewResolution,patientRisk,scheduleSurgery,cancelSurgery,placePostoperativePatient,surgeryEligibility,theatreCapacity,purchaseCost,upkeepCost,unmetNeeds,canEnterWard,radiologyInvestigate,hospitalHomeDischarge} from './engine-v53.js';
...
function facilityStatus(f,assigned,capacity){
  ...
  if(f.key==='rehabilitation')chips.push('<span class="ability"><b>RN</b> Nursing-only admission</span>');
