import {createGame,investigate,treat,admit,buy,advancePhase,assignStaff,returnStaff,placeFacility,compatible,getFacility,previewResolution,patientRisk,scheduleSurgery,cancelSurgery,placePostoperativePatient,surgeryEligibility,theatreCapacity,purchaseCost,upkeepCost,unmetNeeds,canEnterWard,radiologyInvestigate,hospitalHomeDischarge} from './engine-v54.js';
...
function rulesGuide(){
  ...
  <ol class="rules-stages">
    <li><b>Round start</b><span>Scheduled Surgery resolves. Postoperative patients must receive ward beds. Pharmacists generate Medication. Patient arrivals increase every four rounds: 2 in rounds 1â€“4, 3 in rounds 5â€“8, and 4 in rounds 9â€“12.</span></li>
